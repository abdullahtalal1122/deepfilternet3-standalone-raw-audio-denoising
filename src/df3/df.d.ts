...
/**
* Asynchronously instantiates the WASM module from bytes or a URL.
*
* @param {InitInput | Promise<InitInput>} module_or_path
*
* @returns {Promise<InitOutput>}
*/
export function initAsync(module_or_path: InitInput | Promise<InitInput>): Promise<InitOutput>;
